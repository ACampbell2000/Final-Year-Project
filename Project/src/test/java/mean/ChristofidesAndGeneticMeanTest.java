...
public class ChristofidesAndGeneticMeanTest {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i< 30; i++) {
            ...
            System.out.println("Christofides: " + individual.toString());
            GeneticAlgorithm geneticAlgorithm = new GeneticAlgorithm(testGraph, individual);
            System.out.println("Best: " + geneticAlgorithm.getBest().toString());
